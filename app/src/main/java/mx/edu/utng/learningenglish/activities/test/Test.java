...
import mx.edu.utng.learningenglish.activities.CertificateActivity;
...
//PREGUNTAS DEL QUIZ
       ...
       if(rbDog.isChecked()){
        ...
        if(btSend.isPressed()){
            ...
            String data = db.getScore(idUser, 6);
            if(data!=null){
                db.updateScore(idUser,6,String.valueOf(scoreTest));
            }else{
                db.addScore(String.valueOf(scoreTest),idUser,6);
            }
            if(scoreTest>=8){
