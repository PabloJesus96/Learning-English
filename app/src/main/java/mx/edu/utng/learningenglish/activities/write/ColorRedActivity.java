...
public class ColorRedActivity extends AppCompatActivity {
    ...
    public void initComponents(){
        ...
        LinearLayoutManager manager = new LinearLayoutManager(ColorRedActivity.this);
        rvList.setLayoutManager(manager);

        writings.add(new ActivityWriting(R.drawable.red_writing, "escribe el color indicado:", "R _ D  ", "",R.color.enable));
            ...
            public void onClick(View v) {
                switch (v.getId()){
                    case R.id.bt_completed:
                        ...
                        if(colorcito.equalsIgnoreCase("red")){
                            tvColor.setText("R E D  ");

                            int secondsDelayed = 1000;
                            new Handler().postDelayed(new Runnable() {
                                public void run() {
                                    AlertDialog.Builder builder = new AlertDialog.Builder(ColorRedActivity.this);
                                    builder.setMessage("\nEL SIGUIENTE COLOR ES: ")
                                            ...
                                            .setPositiveButton("ACEPTAR", new DialogInterface.OnClickListener() {
                                                public void onClick(DialogInterface dialog, int id) {
                                                    startActivity(new Intent(ColorRedActivity.this,ColorBlackActivity.class));
                                                }
                                            });
                                    builder.show();
                                    //finish();
