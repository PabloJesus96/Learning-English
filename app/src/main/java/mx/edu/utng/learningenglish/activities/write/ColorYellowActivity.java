...
public class ColorYellowActivity extends AppCompatActivity {
    ...
    public void initComponents(){
        ...
        LinearLayoutManager manager = new LinearLayoutManager(ColorYellowActivity.this);
        rvList.setLayoutManager(manager);

        writings.add(new ActivityWriting(R.drawable.yellow_writing, "escribe el color indicado:", "Y E _ L _ W  ", "",R.color.enable));
            ...
            public void onClick(View v) {
                switch (v.getId()){
                    case R.id.bt_completed:
                        ...
                        if(colorcito.equalsIgnoreCase("yellow")){
                            tvColor.setText("Y E L L O W  ");

                            int secondsDelayed = 1000;
                            new Handler().postDelayed(new Runnable() {
                                public void run() {
                                    AlertDialog.Builder builder = new AlertDialog.Builder(ColorYellowActivity.this);
                                    builder.setMessage("\nEL SIGUIENTE COLOR ES: ")
                                            ...
                                            .setPositiveButton("ACEPTAR", new DialogInterface.OnClickListener() {
                                                public void onClick(DialogInterface dialog, int id) {
                                                    startActivity(new Intent(ColorYellowActivity.this,ColorWhiteActivity.class));
                                                }
                                            });
                                    builder.show();
                                    //finish();
