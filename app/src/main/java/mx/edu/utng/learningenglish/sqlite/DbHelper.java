package mx.edu.utng.learningenglish.sqlite;
...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public String getUserName(String userEmail){
        String selectQuery="select "+COLUMN_NOMBRE_USUARIO+" ,"+COLUMN_APELLIDOS_USUARIO+" from "+ USER_TABLE +" where "+COLUMN_EMAIL+ " = "+"'"+userEmail+"';";
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.rawQuery(selectQuery, null);
        cursor.moveToFirst();
