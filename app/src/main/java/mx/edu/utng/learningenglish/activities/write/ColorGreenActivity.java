...
public class ColorGreenActivity extends AppCompatActivity {
    ...
    public void initComponents(){
        ...
        LinearLayoutManager manager = new LinearLayoutManager(ColorGreenActivity.this);
        rvList.setLayoutManager(manager);

        writings.add(new ActivityWriting(R.drawable.green_writing, "escribe el color indicado:", " G _ E _ N  ", "",R.color.enable));
            ...
            public void onClick(View v) {
                switch (v.getId()){
                    case R.id.bt_completed:
                        ...
                        if(colorcito.equalsIgnoreCase("green")){
                            tvColor.setText(" G R E E N  ");

                            int secondsDelayed = 1000;
                            new Handler().postDelayed(new Runnable() {
                                public void run() {
                                    AlertDialog.Builder builder = new AlertDialog.Builder(ColorGreenActivity.this);
                                    builder.setMessage("\nEL SIGUIENTE COLOR ES: ")
                                            ...
                                            .setPositiveButton("ACEPTAR", new DialogInterface.OnClickListener() {
                                                public void onClick(DialogInterface dialog, int id) {
                                                    startActivity(new Intent(ColorGreenActivity.this,ColorPinkActivity.class));
                                                }
                                            });
                                    builder.show();
                                    //finish();
