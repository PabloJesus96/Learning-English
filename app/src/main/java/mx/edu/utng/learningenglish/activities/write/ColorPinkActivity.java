...
public class ColorPinkActivity extends AppCompatActivity {
    ...
    public void initComponents(){
        ...
        LinearLayoutManager manager = new LinearLayoutManager(ColorPinkActivity.this);
        rvList.setLayoutManager(manager);

        writings.add(new ActivityWriting(R.drawable.pink_writing, "escribe el color indicado:", " _ I _ K  ", "",R.color.enable));
                                    ...
                                    builder.setMessage("\nEL SIGUIENTE COLOR ES: ")
                                            ...
                                            .setPositiveButton("ACEPTAR", new DialogInterface.OnClickListener() {
                                                public void onClick(DialogInterface dialog, int id) {
                                                    startActivity(new Intent(ColorPinkActivity.this,ColorBrownActivity.class));
                                                }
                                            });
                                    builder.show();
                                    //finish();
